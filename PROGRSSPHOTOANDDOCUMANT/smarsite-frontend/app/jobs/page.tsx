      ...
      {error && (
        <div className="mb-8 rounded-2xl border border-red-500/30 bg-red-500/10 p-6 shadow-lg shadow-black/20 backdrop-blur-md">
          <p className="text-red-300 font-medium">
            Impossible de charger les jobs. Démarrez Nest sur le port 3200 ou vérifiez{" "}
            <code className="rounded bg-muted px-1">NEXT_PUBLIC_API_URL</code> / proxy{" "}
            <code className="rounded bg-muted px-1">/api-backend</code>.
          </p>
